  ...
  pt: {
    ...
    voices: [
      ...
      },
      {
        ...
        detail: 'Voz masculina brasileira de 18ª geração criada por ZONERYTH para UTAU, com múltiplos idiomas e timbres expressivos que abrangem de tons suaves a potentes.',
        tags: ['UTAU', 'OpenUTAU', 'Multilíngue'],
        ...
        specs: {
          ...
          range: 'C2 ~ B5',
          description: 'Criado e gravado por ZONERYTH, Kodama Kito (児玉キト) possui bancos em formatos CVVC, VCV e CVC BRAPA para o português brasileiro, além de japonês e inglês. Seu V2 conta com 5 Voice Colors (Dark, Mature, Power, Sweet e Weak), além de bancos temáticos como o -tired-.',
  ...
  en: {
    ...
    voices: [
      ...
      },
      {
        ...
        detail: '18th generation Brazilian male voice created by ZONERYTH for UTAU, featuring multiple languages and expressive voice colors ranging from soft to powerful tones.',
        tags: ['UTAU', 'OpenUTAU', 'Multilingual'],
        profile: 'https://vsynthbr.fandom.com/pt-br/wiki/Kodama_Kito',
        owner: 'https://www.youtube.com/@ZoneLoid',
        ownerName: 'ZONERYTH',
        ...
        specs: {
          ...
          range: 'C2 ~ B5',
          description: 'Created and voiced by ZONERYTH, Kodama Kito (児玉キト) features voicebanks in CVVC, VCV, and CVC BRAPA for Brazilian Portuguese, alongside Japanese and English. His V2 release includes 5 Voice Colors (Dark, Mature, Power, Sweet, Weak) as well as the special -tired- soft bank.',
          downloadUrl: 'https://vsynthbr.fandom.com/pt-br/wiki/Kodama_Kito#Downloads',
        },
      },
    ],
  ...
  ar: {
    ...
    voices: [
      ...
      },
      {
        ...
        detail: 'صوت ذكوري برازيلي من الجيل 18 من ابتكار ZONERYTH لبرنامج UTAU، يدعم لغات متعددة وطبقات تعبيرية متنوعة من النغمات الهادئة إلى القوية.',
        tags: ['UTAU', 'OpenUTAU', 'متعدد اللغات'],
        profile: 'https://vsynthbr.fandom.com/pt-br/wiki/Kodama_Kito',
        owner: 'https://www.youtube.com/@ZoneLoid',
        ownerName: 'ZONERYTH',
        ...
        specs: {
          ...
          range: 'C2 ~ B5',
          description: 'صوت غنائي من ابتكار وتسجيل ZONERYTH، يتميز Kodama Kito (児玉キト) ببنوك صوتية بصيغ CVVC و VCV و CVC BRAPA للبرتغالية البرازيلية إلى جانب الإنجليزية واليابانية، مع 5 تلوينات صوتية (Dark, Mature, Power, Sweet, Weak) وبنك -tired- الناعم.',
          downloadUrl: 'https://vsynthbr.fandom.com/pt-br/wiki/Kodama_Kito#Downloads',
        },
      },
    ],
  ...
  ru: {
    ...
    voices: [
      ...
      },
      {
        ...
        detail: 'Бразильский мужской голос 18-го поколения, созданный ZONERYTH для UTAU, поддерживающий несколько языков и выразительные голосовые тембры от мягких до мощных.',
        tags: ['UTAU', 'OpenUTAU', 'Многоязычный'],
        profile: 'https://vsynthbr.fandom.com/pt-br/wiki/Kodama_Kito',
        owner: 'https://www.youtube.com/@ZoneLoid',
        ownerName: 'ZONERYTH',
        ...
        specs: {
          ...
          range: 'C2 ~ B5',
          description: 'Созданный и записанный ZONERYTH, Kodama Kito (児玉キト) включает голосовые базы в форматах CVVC, VCV и CVC BRAPA для бразильского португальского, а также японского и английского языков. Версия V2 включает 5 тембров (Dark, Mature, Power, Sweet, Weak) и мягкий банк -tired-.',
          downloadUrl: 'https://vsynthbr.fandom.com/pt-br/wiki/Kodama_Kito#Downloads',
        },
      },
    ],
  ...
  ja: {
    ...
    voices: [
      ...
      },
      {
        ...
        accent: '#7058a6',
        meta: '第18世代 · 2026年〜',
        detail: 'ZONERYTHによって制作された第18世代UTAU向けブラジル男性音源。穏やかなトーンからパワフルな歌唱まで多彩な表情（Voice Colors）と多言語に対応。',
        tags: ['UTAU', 'OpenUTAU', '多言語対応'],
        profile: 'https://vsynthbr.fandom.com/pt-br/wiki/Kodama_Kito',
        owner: 'https://www.youtube.com/@ZoneLoid',
        ownerName: 'ZONERYTH',
        ...
        specs: {
          ...
          range: 'C2 ~ B5',
          description: 'ZONERYTHによって制作・録音されたKodama Kito（児玉キト）。CVVC、VCV、そしてブラジルポルトガル語向けのCVC BRAPA、日本語、英語の多彩な音源を展開。V2では5種類のVoice Colors（Dark, Mature, Power, Sweet, Weak）やソフト音源「-tired-」を搭載。',
          downloadUrl: 'https://vsynthbr.fandom.com/pt-br/wiki/Kodama_Kito#Downloads',
        },
      },
    ],
